...
import com.example.cropcart.product.AddProductActivity
import com.example.cropcart.product.FeaturedProduct
import com.example.cropcart.product.MyProductsActivity
...
class SellFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnOrders = view.findViewById<MaterialCardView>(R.id.btnOrders)
        val btnMyproducts = view.findViewById<MaterialCardView>(R.id.btnYourProducts)
        val btnAddProduct = view.findViewById<MaterialCardView>(R.id.btnAddOrder)
